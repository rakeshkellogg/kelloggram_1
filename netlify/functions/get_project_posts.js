...
exports.handler = async function(event) {
  ...
  // take the projectId from the front end and only look at project posts with the right ugly room ID
  let postsQuery = await db.collection('projectposts').where('project', '==', projectId)
                           .get()
